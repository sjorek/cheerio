...
render = module.exports = function(dom, opts) {
  ...
  _.each(dom, function(elem) {
    var pushVal,
        elemTagType = tagType[elem.type],
        isSingleTag = singleTag[elem.name];

    if (elemTagType)
      pushVal = renderTag(elem, (isSingleTag && xmlMode));
...
var renderTag = function(elem, closedXmlTag) {
  var tag = '<' + elem.name;
